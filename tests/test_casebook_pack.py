"""Regression checks for the thread-rel-backup-probe casebook."""
...
from casebook.harness import assert_expected, thread_rel_backup_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(thread_rel_backup_probe_summary(), assert_expected())
